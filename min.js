...
async function sendMessageWithRandomDelay(message) {
    const typingDelay = Math.floor(Math.random() * 2000) + 2000; // Range of [2000, 4000] milliseconds
    const sendDelay = Math.floor(Math.random() * 2500) + 2500; // Range of [1500, 5000] milliseconds
