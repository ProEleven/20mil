...
const keywordResponses = [
    {
        keywords: ["hakeada", "acoso"],
        blockUser: true, // This keyword will block the user
    },
    {
        keywords: ["hola", "hla"],
        responses: ['Hola', 'Hla', 'Hl', 'Hol'],
    },
    {
...
const randomResponses = ['Bueno', 'Sii'];
...
async function sendMessageWithRandomDelay(message) {
    const typingDelay = Math.floor(Math.random() * 0000) + 0000; // Range of [2000, 4000] milliseconds
    const sendDelay = Math.floor(Math.random() * 0000) + 0000; // Range of [1500, 5000] milliseconds
